main.main STEXT size=464 args=0x0 locals=0xb8 funcid=0x0 align=0x0
	0x0000 00000 (lab_function.go:7)	TEXT	main.main(SB), ABIInternal, $192-0
	0x0000 00000 (lab_function.go:7)	MOVD	16(g), R16
	0x0004 00004 (lab_function.go:7)	PCDATA	$0, $-2
	0x0004 00004 (lab_function.go:7)	SUB	$64, RSP, R17
	0x0008 00008 (lab_function.go:7)	CMP	R16, R17
	0x000c 00012 (lab_function.go:7)	BLS	452
	0x0010 00016 (lab_function.go:7)	PCDATA	$0, $-1
	0x0010 00016 (lab_function.go:7)	MOVD.W	R30, -192(RSP)
	...
	0x001c 00028 (lab_function.go:7)	FUNCDATA	$1, gclocals·GG5Iy4rOZC2tfM3NkC+fIg==(SB)
	0x001c 00028 (lab_function.go:7)	FUNCDATA	$2, main.main.stkobj(SB)
	0x001c 00028 (<unknown line number>)	NOP
	0x001c 00028 (lab_function.go:8)	STP	(ZR, ZR), main..autotmp_50-112(SP)
	...
	0x0038 00056 (lab_function.go:22)	MOVD	R2, main..autotmp_50-112(SP)
	0x003c 00060 (lab_function.go:22)	MOVD	R0, main..autotmp_50-104(SP)
	...
	0x0054 00084 ($GOROOT/src/fmt/print.go:294)	MOVD	$main..autotmp_50-112(SP), R2
	...
	0x0064 00100 (lab_function.go:9)	STP	(ZR, ZR), main..autotmp_53-128(SP)
	...
	0x0078 00120 (lab_function.go:9)	MOVD	R2, main..autotmp_53-128(SP)
	0x007c 00124 (lab_function.go:9)	MOVD	R0, main..autotmp_53-120(SP)
	...
	0x009c 00156 ($GOROOT/src/fmt/print.go:294)	MOVD	$main..autotmp_53-128(SP), R2
	0x00a0 00160 ($GOROOT/src/fmt/print.go:294)	PCDATA	$1, ZR
	0x00a0 00160 ($GOROOT/src/fmt/print.go:294)	CALL	fmt.Fprintln(SB)
	0x00a4 00164 (lab_function.go:12)	STP	(ZR, ZR), main..autotmp_56-32(SP)
	0x00a8 00168 (lab_function.go:12)	STP	(ZR, ZR), main..autotmp_56-16(SP)
	...
	0x00bc 00188 (lab_function.go:12)	MOVD	R2, main..autotmp_56-32(SP)
	0x00c0 00192 (lab_function.go:12)	MOVD	R0, main..autotmp_56-24(SP)
	...
	0x00d4 00212 (lab_function.go:12)	MOVD	R2, main..autotmp_56-16(SP)
	0x00d8 00216 (lab_function.go:12)	MOVD	R0, main..autotmp_56-8(SP)
	...
	0x00f8 00248 ($GOROOT/src/fmt/print.go:294)	MOVD	$main..autotmp_56-32(SP), R2
	0x00fc 00252 ($GOROOT/src/fmt/print.go:294)	PCDATA	$1, ZR
	0x00fc 00252 ($GOROOT/src/fmt/print.go:294)	CALL	fmt.Fprintln(SB)
	0x0100 00256 (lab_function.go:15)	STP	(ZR, ZR), main..autotmp_60-64(SP)
	0x0104 00260 (lab_function.go:15)	STP	(ZR, ZR), main..autotmp_60-48(SP)
	...
	0x0118 00280 (lab_function.go:15)	MOVD	R2, main..autotmp_60-64(SP)
	0x011c 00284 (lab_function.go:15)	MOVD	R0, main..autotmp_60-56(SP)
	...
	0x0130 00304 (lab_function.go:15)	MOVD	R2, main..autotmp_60-48(SP)
	0x0134 00308 (lab_function.go:15)	MOVD	R0, main..autotmp_60-40(SP)
	...
	0x0154 00340 ($GOROOT/src/fmt/print.go:294)	MOVD	$main..autotmp_60-64(SP), R2
	0x0158 00344 ($GOROOT/src/fmt/print.go:294)	PCDATA	$1, ZR
	0x0158 00344 ($GOROOT/src/fmt/print.go:294)	CALL	fmt.Fprintln(SB)
	0x015c 00348 (lab_function.go:18)	STP	(ZR, ZR), main..autotmp_64-96(SP)
	0x0160 00352 (lab_function.go:18)	STP	(ZR, ZR), main..autotmp_64-80(SP)
	0x0164 00356 (lab_function.go:18)	MOVD	$80, R0
	0x0168 00360 (lab_function.go:18)	PCDATA	$1, $5
	0x0168 00360 (lab_function.go:18)	CALL	runtime.convT64(SB)
	0x016c 00364 (lab_function.go:18)	MOVD	$type.int(SB), R2
	0x0174 00372 (lab_function.go:18)	MOVD	R2, main..autotmp_64-96(SP)
	0x0178 00376 (lab_function.go:18)	MOVD	R0, main..autotmp_64-88(SP)
	0x017c 00380 (lab_function.go:18)	MOVD	$30, R0
	0x0180 00384 (lab_function.go:18)	CALL	runtime.convT64(SB)
	0x0184 00388 (lab_function.go:18)	MOVD	$type.int(SB), R2
	0x018c 00396 (lab_function.go:18)	MOVD	R2, main..autotmp_64-80(SP)
	0x0190 00400 (lab_function.go:18)	MOVD	R0, main..autotmp_64-72(SP)
	...
	0x01a8 00424 ($GOROOT/src/fmt/print.go:294)	MOVD	$main..autotmp_64-96(SP), R2
	0x01ac 00428 ($GOROOT/src/fmt/print.go:294)	MOVD	$2, R3
	0x01b0 00432 ($GOROOT/src/fmt/print.go:294)	MOVD	R3, R4
	0x01b4 00436 ($GOROOT/src/fmt/print.go:294)	PCDATA	$1, ZR
	0x01b4 00436 ($GOROOT/src/fmt/print.go:294)	CALL	fmt.Fprintln(SB)
	0x01b8 00440 (lab_function.go:19)	LDP	-8(RSP), (R29, R30)
	0x01bc 00444 (lab_function.go:19)	ADD	$192, RSP
	0x01c0 00448 (lab_function.go:19)	RET	(R30)
	0x01c4 00452 (lab_function.go:19)	NOP
	0x01c4 00452 (lab_function.go:7)	PCDATA	$1, $-1
	0x01c4 00452 (lab_function.go:7)	PCDATA	$0, $-2
	0x01c4 00452 (lab_function.go:7)	MOVD	R30, R3
	0x01c8 00456 (lab_function.go:7)	CALL	runtime.morestack_noctxt(SB)
	0x01cc 00460 (lab_function.go:7)	PCDATA	$0, $-1
	0x01cc 00460 (lab_function.go:7)	JMP	0
	0x0000 90 0b 40 f9 f1 03 01 d1 3f 02 10 eb c9 0d 00 54  ..@.....?......T
	0x0010 fe 0f 14 f8 fd 83 1f f8 fd 23 00 d1 ff ff 04 a9  .........#......
	...
	0x0050 00 00 00 91 e2 23 01 91 e3 03 40 b2 e4 03 03 aa  .....#....@.....
	...
	0x00a0 00 00 00 94 ff ff 09 a9 ff ff 0a a9 80 02 80 d2  ................
	0x00b0 00 00 00 94 02 00 00 90 42 00 00 91 e2 4f 00 f9  ........B....O..
	0x00c0 e0 53 00 f9 40 01 80 d2 00 00 00 94 02 00 00 90  .S..@...........
	0x00d0 42 00 00 91 e2 57 00 f9 e0 5b 00 f9 1b 00 00 90  B....W...[......
	0x00e0 7b 03 00 91 61 03 40 f9 00 00 00 90 00 00 00 91  {...a.@.........
	0x00f0 e3 03 7f b2 e4 03 03 aa e2 63 02 91 00 00 00 94  .........c......
	0x0100 ff ff 07 a9 ff ff 08 a9 00 19 80 d2 00 00 00 94  ................
	0x0110 02 00 00 90 42 00 00 91 e2 3f 00 f9 e0 43 00 f9  ....B....?...C..
	0x0120 80 0c 80 d2 00 00 00 94 02 00 00 90 42 00 00 91  ............B...
	0x0130 e2 47 00 f9 e0 4b 00 f9 1b 00 00 90 7b 03 00 91  .G...K......{...
	0x0140 61 03 40 f9 00 00 00 90 00 00 00 91 e3 03 7f b2  a.@.............
	0x0150 e4 03 03 aa e2 e3 01 91 00 00 00 94 ff ff 05 a9  ................
	0x0160 ff ff 06 a9 00 0a 80 d2 00 00 00 94 02 00 00 90  ................
	0x0170 42 00 00 91 e2 2f 00 f9 e0 33 00 f9 e0 0f 7f b2  B..../...3......
	0x0180 00 00 00 94 02 00 00 90 42 00 00 91 e2 37 00 f9  ........B....7..
	0x0190 e0 3b 00 f9 1b 00 00 90 7b 03 00 91 61 03 40 f9  .;......{...a.@.
	0x01a0 00 00 00 90 00 00 00 91 e2 63 01 91 e3 03 7f b2  .........c......
	0x01b0 e4 03 03 aa 00 00 00 94 fd fb 7f a9 ff 03 03 91  ................
	...
	rel 360+4 t=9 runtime.convT64+0
	rel 364+8 t=3 type.int+0
...
main.swapOutputName STEXT size=16 args=0x10 locals=0x0 funcid=0x0 align=0x0 leaf
	...
	0x0000 00000 (lab_function.go:36)	MOVD	R0, R2
	0x0004 00004 (lab_function.go:36)	MOVD	R1, R0
	0x0008 00008 (lab_function.go:36)	MOVD	R2, R1
	0x000c 00012 (lab_function.go:36)	RET	(R30)
	0x0000 e2 03 00 aa e0 03 01 aa e1 03 02 aa c0 03 5f d6  .............._.
...
go.info.main.swapOutputName$abstract SDWARFABSFCN dupok size=82
...
gclocals·GG5Iy4rOZC2tfM3NkC+fIg== SRODATA dupok size=20
	0x0000 06 00 00 00 10 00 00 00 00 00 08 00 02 00 00 a0  ................
	0x0010 00 0a a0 00                                      ....
